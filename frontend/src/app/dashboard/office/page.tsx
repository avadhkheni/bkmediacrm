...
export default function OfficeDashboard() {
  ...
  const stats = {
    video: tasks.filter(t => t.subDepartment === "VIDEO_EDITING").length,
    graphics: tasks.filter(t => t.subDepartment === "GRAPHIC_DESIGN").length,
    social: tasks.filter(t => t.subDepartment === "SOCIAL_MEDIA").length,
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
          ...
          <div className="text-2xl font-black text-slate-800 dark:text-white">{stats.video}</div>
        </div>
        <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Graphics</span>
          </div>
          <div className="text-2xl font-black text-slate-800 dark:text-white">{stats.graphics}</div>
        </div>
        <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Social</span>
          </div>
          <div className="text-2xl font-black text-slate-800 dark:text-white">{stats.social}</div>
        </div>
        <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm border-l-4 border-l-red-500">
          <div className="flex items-center gap-3 mb-2">
            <div className="p-2 bg-red-50 dark:bg-red-900/20 rounded-lg text-red-600 dark:text-red-400">
              <AlertCircle className="w-5 h-5" />
            </div>
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Urgent</span>
          </div>
          <div className="text-2xl font-black text-slate-800 dark:text-white">{stats.urgent}</div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col md:flex-row gap-4 items-center">
        <div className="relative flex-1 w-full">
          ...
          <input 
            ...
            className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-700 rounded-xl py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-blue-500 transition-all outline-none"
          />
        </div>
        <div className="flex gap-2 w-full md:w-auto">
          <select 
            ...
            className="bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-700 rounded-xl py-2 px-3 text-sm font-medium outline-none"
          >
